<script lang="ts">
	...
	let { titleSlug = '' }: { titleSlug?: string } = $props();
</script>
...
<header class="sticky top-0 z-50 border-b border-border-gray bg-white">
	<div class="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
		<a href="/" class="flex shrink-0 items-center gap-2.5 group">
			...
			<span class="text-lg font-semibold tracking-tight text-ink group-hover:text-red transition-colors">MA Regulations</span>
		</a>
